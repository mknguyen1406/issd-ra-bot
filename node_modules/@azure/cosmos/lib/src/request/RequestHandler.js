...
class RequestHandler {
    ...
    headers, authOptions, resourceId, resourceType) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // TODO: any
            ...
            if (buffer) {
                ...
                return retry_1.RetryUtility.execute(globalEndpointManager, buffer, this.createRequestObjectStub, connectionPolicy, requestOptions, request, authOptions, resourceId, resourceType);
            }
            else {
                return retry_1.RetryUtility.execute(globalEndpointManager, null, this.createRequestObjectStub, connectionPolicy, requestOptions, request, authOptions, resourceId, resourceType);
            }
        });
    }
    /** @ignore */
    get(urlString, request, headers, authOptions, resourceId, resourceType) {
        // TODO: any
        return RequestHandler.request(this.globalEndpointManager, this.connectionPolicy, this.requestAgent, "GET", urlString, request, undefined, "", headers, authOptions, resourceId, resourceType);
    }
    /** @ignore */
    post(urlString, request, body, headers, authOptions, resourceId, resourceType) {
        // TODO: any
        return RequestHandler.request(this.globalEndpointManager, this.connectionPolicy, this.requestAgent, "POST", urlString, request, body, "", headers, authOptions, resourceId, resourceType);
    }
    /** @ignore */
    put(urlString, request, body, headers, authOptions, resourceId, resourceType) {
        // TODO: any
        return RequestHandler.request(this.globalEndpointManager, this.connectionPolicy, this.requestAgent, "PUT", urlString, request, body, "", headers, authOptions, resourceId, resourceType);
    }
    /** @ignore */
    head(urlString, request, headers, authOptions, resourceId, resourceType) {
        // TODO: any
        return RequestHandler.request(this.globalEndpointManager, this.connectionPolicy, this.requestAgent, "HEAD", urlString, request, undefined, "", headers, authOptions, resourceId, resourceType);
    }
    /** @ignore */
    delete(urlString, request, headers, authOptions, resourceId, resourceType) {
        return RequestHandler.request(this.globalEndpointManager, this.connectionPolicy, this.requestAgent, "DELETE", urlString, request, undefined, "", headers, authOptions, resourceId, resourceType);
    }
}
