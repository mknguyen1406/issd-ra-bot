...
class ClientContext {
    ...
    read(path, type, id, initialHeaders, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.requestHandler.get(endpoint, request, requestHeaders, this.cosmosClientOptions.auth, id, type);
    ...
    query, options, partitionKeyRangeId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (query === undefined) {
                ...
                const response = yield this.requestHandler.get(endpoint, request, reqHeaders, this.cosmosClientOptions.auth, id, type);
                ...
                this.applySessionToken(path, reqHeaders);
                const response = yield this.requestHandler.post(endpoint, request, query, reqHeaders, this.cosmosClientOptions.auth, id, type);
                this.captureSessionToken(undefined, path, _1.Constants.OperationTypes.Query, response.headers);
                return this.processQueryFeedResponse(response, !!query, resultFn);
            }
        });
    ...
    delete(path, type, id, initialHeaders, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request);
                const response = yield this.requestHandler.delete(endpoint, request, reqHeaders, this.cosmosClientOptions.auth, id, type);
    ...
    create(body, path, type, id, initialHeaders, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.applySessionToken(path, requestHeaders);
                const endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request);
                const response = yield this.requestHandler.post(endpoint, request, body, requestHeaders, this.cosmosClientOptions.auth, id, type);
    ...
    replace(resource, path, type, id, initialHeaders, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.requestHandler.put(endpoint, request, resource, reqHeaders, this.cosmosClientOptions.auth, id, type);
    ...
    options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const type = "sprocs";
            const headers = yield request_2.getHeaders(this.cosmosClientOptions.auth, initialHeaders, "post", path, id, type, options, undefined, this.cosmosClientOptions.connectionPolicy.UseMultipleWriteLocations);
            const request = {
                client: this,
    ...
    getDatabaseAccount(options = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { result, headers } = yield this.requestHandler.get(urlConnection, request, requestHeaders, this.cosmosClientOptions.auth, "", "");
