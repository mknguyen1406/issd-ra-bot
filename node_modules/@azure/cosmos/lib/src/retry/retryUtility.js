...
class RetryUtility {
     ...
     */
    static execute(globalEndpointManager, body, createRequestObjectFunc, connectionPolicy, requestOptions, request, authOptions, resourceId, resourceType) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return this.apply(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, {}, authOptions, resourceId, resourceType);
        });
    }
    /**
     ...
     */
    static apply(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, retryContext, authOptions, resourceId, resourceType) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            // TODO: any response
            ...
            if (!requestOptions.headers[common_1.Constants.HttpHeaders.Authorization]) {
                const header = yield auth_1.AuthHandler.getAuthorizationHeader(authOptions, requestOptions.method, requestOptions.path, resourceId, resourceType, requestOptions.headers);
                if (header) {
                    requestOptions.headers[common_1.Constants.HttpHeaders.Authorization] = header;
                }
            }
            ...
            try {
                ...
                if (!results) {
                    ...
                    return this.apply(body, createRequestObjectFunc, connectionPolicy, requestOptions, endpointDiscoveryRetryPolicy, resourceThrottleRetryPolicy, sessionReadRetryPolicy, defaultRetryPolicy, globalEndpointManager, request, retryContext, authOptions, resourceId, resourceType);
                }
            }
        });
    }
