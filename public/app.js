...
const experimentGroup = (url.searchParams.get("experimentGroup" || url.searchParams.get("experimentGroup") === "") === null) ? 2 : url.searchParams.get("experimentGroup"); // 2 as default
